...
import './Contact.css';
import { emailValidate, phoneNumberValidate } from './helper';
...
const Contact = ({ setUser, user }) => {
  ...
  function handleSubmit(e) {
    ...
    if (emailValidate(email) && phoneNumberValidate(telephone)) {
      setErr(false);
      setUser({
        firstName: firstName,
        lastName: lastName,
    ...
    <div className="contact_page">
      {user ? (
        <div className="feedback">
          ...
          <p>
            {' '}
            Thank you for joining us. All your information has been collected.
          </p>
          <p>
            <span>Contact Preferance: {preferance} </span>
            {preferance === 'Email' ? user.email : user.telephone}
          </p>
          ...
          {!user.hear_from ? (
            ...
            <p>
              Finally, thank you for sharing with us that you hear us from{' '}
              {user.hear_from}
            </p>
          )}
        </div>
          ...
          <div className="overview">
            ...
            <div>
              <input
                ...
                required
              />
              <label htmlFor="nice"> Morning</label>
            </div>
            <div>
              <input
                type="radio"
                ...
                value="afternoon"
              />
              <label htmlFor="good"> Afternoon</label>
            </div>
            <div>
              <input
                type="radio"
                ...
                value="evenings"
              />
              <label htmlFor="good"> Evenings</label>
            </div>
          </div>
      ...
      <div className="contact_text">
        {err ? (
          ...
          <>
            ...
            <p>
              Join our monthly movie membership and make FREE online
              reservations in advance. Watch movies in any format, including AAA
              Cinema, IMAX, Real 3D and more. Plus, indulge in the premium perks
              of AAA Stubs Premiere, including 10% back on food & drink
              purchases. Reserve a ticket as soon as you join.
            </p>
          </>
        )}
      </div>
