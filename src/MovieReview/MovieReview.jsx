...
const MoviewReview = ({ data, id, setSubmittedForm, submittedForm }) => {
  ...
  function onSubmit(e) {
    ...
    switch (general_review) {
      case "4": {
        general_review_back = <span><FaStar /><FaStar /><FaStar /><FaStar /></span>
        break;
      }
      case "3": {
        general_review_back = <span><FaStar /><FaStar /><FaStar /></span>
        break;
      }
      case "2": {
        general_review_back = <span><FaStar /><FaStar /></span>
        break;
      }
      default:
        general_review_back = <span><FaStar /></span>
    }
    ...
    setSubmittedForm({ 'general': general_review_back, 'detail': detail_review, 'title': movie_title_map.get(parseInt(movie_review)) })
  };
        ...
        <>
          <form onSubmit={onSubmit} className='form'>
            ...
            <div className='overview'>
              <div><input type="radio" name="overview_rate" id="nice" value="4" required /><label htmlFor="nice"><FaStar /><FaStar /><FaStar /><FaStar /></label></div>
              <div><input type="radio" name="overview_rate" id="good" value="3" /><label htmlFor="good"><FaStar /><FaStar /><FaStar /></label></div>
              <div><input type="radio" name="overview_rate" id="ok" value="2" /><label htmlFor="ok"><FaStar /><FaStar /></label></div>
              <div><input type="radio" name="overview_rate" id="bad" value="1" /><label htmlFor="bad"><FaStar /></label></div>
            </div>
